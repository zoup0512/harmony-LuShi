...
export declare class CmakeUtil {
    ...
    /**
     * 获取用户在 hvigor-config 中配置的 Release 的 CMake 编译类型
     *
     * @param buildType 构建模式 (debug/release)
     * @returns CMake 构建类型 (Debug/Release/RelWithDebInfo)
     */
    static getConfigCMakeBuildType(buildType: string): string;
}
/**
 * cmake参数model
 *
