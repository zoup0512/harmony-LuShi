...
export declare class InjectUtil {
    ...
    static isIntegratedHspUseGetCurrentBundleName(): boolean;
    static isDependenciesTypesEnable(): boolean;
    static getAlignDeviceTypes(): string[];
    /**
     * 判断是否测试框架
     */
     ...
     * 是否开启单文件落盘
     */
    static isSingleFileEmitEnabled(): boolean;
    /**
     * 是否执行 --sync
     */
    static isSync(): boolean;
    /**
     * 场景“onDeviceTest + ohosTest + har”
     */
    static isHarDeviceTestWithOhosTest(targetService: TargetTaskService): boolean;
}
