...
export declare namespace TaskNames {
    ...
    class Task {
        static readonly PROCESS_OBFUSCATION_FILES: TaskDetails;
        static readonly PACKING_CHECK: TaskDetails;
        static readonly PACKING_CHECK_HAR: TaskDetails;
        ...
        static readonly BUILD_INFO: TaskDetails;
        static readonly PROCESS_MODULE_PRIVACY_PROFILE: TaskDetails;
        static readonly PROCESS_PROJECT_PRIVACY_PROFILE: TaskDetails;
        static readonly MERGE_PROFILE: TaskDetails;
        static readonly BUILD_NATIVE_WITH_CMAKE: TaskDetails;
        static readonly PROCESS_COMPILED_RESOURCES: TaskDetails;
        static readonly PROCESS_ID_DEFINED_FILE: TaskDetails;
        static readonly REMOVE_DUPLICATE_HAR_RESOURCES: TaskDetails;
        static readonly PACKAGE_HAP: TaskDetails;
        ...
        static readonly SIGN_PACKAGES_FROM_APP: TaskDetails;
        ...
        static readonly DO_NATIVE_BINXO: TaskDetails;
        ...
        static readonly COLLECT_DEDUPLICATE_HAR_ENTRIES: TaskDetails;
        ...
        static readonly PROCESS_SHARE_CONFIG: TaskDetails;
        ...
        static readonly GENERATE_PKG_SDK_INFO: TaskDetails;
