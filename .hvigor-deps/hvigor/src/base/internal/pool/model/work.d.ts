...
export declare class Work {
    ...
    private readonly memorySensitive;
    constructor(priority: Priority, targetWorkers: number[] | undefined, workPath: string, inputData?: unknown, sideEffects?: boolean, preludeDeps?: string[], memorySensitive?: boolean);
    /**
     * 获取id
     *
