...
import { BuildInfoCacheService } from './service/buildInfo-cache-service.js';
...
export declare class ProjectCacheService {
    ...
    private getProjectBuildInfoCacheFilePath;
    initialize(): void;
    ...
    getBuildInfo(): Map<string, Snapshot> | undefined;
    /**
