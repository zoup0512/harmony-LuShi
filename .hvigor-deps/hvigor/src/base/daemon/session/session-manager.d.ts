...
declare class SessionManager extends EventEmitter {
    ...
    getSockets(): Socket[];
    getLength(): number;
    getSocketByThreadId(threadId: ThreadId): Socket<import("socket.io").DefaultEventsMap, import("socket.io").DefaultEventsMap, import("socket.io").DefaultEventsMap, any> | undefined;
    getSocketBySocketId(socketId: SocketId): Socket<import("socket.io").DefaultEventsMap, import("socket.io").DefaultEventsMap, import("socket.io").DefaultEventsMap, any> | undefined;
    ...
    getActiveSocket(): Socket<import("socket.io").DefaultEventsMap, import("socket.io").DefaultEventsMap, import("socket.io").DefaultEventsMap, any> | undefined;
    /**
